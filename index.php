	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
	  <div class="container-fluid">
	    ...
	    <div class="nav navbar-nav navbar-right">
			  ...
			  <a href="restaurant-login.php"><button class="btn btn-danger navbar-btn">Restaurant -Sign In &nbsp<span class="glyphicon glyphicon-log-in"></span> </button></a>

			<a href="user-signup.php"><button class="btn btn-danger navbar-btn">Customer -Sign Up &nbsp<span class="glyphicon glyphicon-user"></span> </button></a>&nbsp
	        <a href="user-login.php"><button class="btn btn-danger navbar-btn">Customer -Sign In &nbsp<span class="glyphicon glyphicon-log-in"></span> </button></a>
		</div>
		</div>
		</nav>
		</div>
